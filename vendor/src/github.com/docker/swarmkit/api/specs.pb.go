...
type ContainerSpec struct {
	...
	// Capabilitis to add
	CapAdd []string `protobuf:"bytes,12,rep,name=cap_add,json=capAdd" json:"cap_add,omitempty"`
	// Capabilitis to drop
	CapDrop []string `protobuf:"bytes,13,rep,name=cap_drop,json=capDrop" json:"cap_drop,omitempty"`
}
...
func (m *ContainerSpec) Copy() *ContainerSpec {
	...
	if m.CapAdd != nil {
		o.CapAdd = make([]string, 0, len(m.CapAdd))
		for _, v := range m.CapAdd {
			o.CapAdd = append(o.CapAdd, v)
		}
	}

	if m.CapDrop != nil {
		o.CapDrop = make([]string, 0, len(m.CapDrop))
		for _, v := range m.CapDrop {
			o.CapDrop = append(o.CapDrop, v)
		}
	}
...
func (this *ContainerSpec) GoString() string {
	...
	s = append(s, "CapAdd: "+fmt.Sprintf("%#v", this.CapAdd)+",\n")
	s = append(s, "CapDrop: "+fmt.Sprintf("%#v", this.CapDrop)+",\n")
	s = append(s, "}")
	return strings.Join(s, "")
}
...
var fileDescriptorSpecs = []byte{
	...
	,
}
