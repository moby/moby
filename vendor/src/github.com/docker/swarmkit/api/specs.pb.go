...
type NetworkSpec struct {
	...
	// If a network is marked as legacy, user can run and connect containers onto it
...
// NetworkAttachmentConfig specifies the allocation information
...
type NetworkAttachmentConfig struct {
	...
	// Aliases are the aliases specified for this attachment.
	Aliases []string `protobuf:"bytes,5,rep,name=aliases" json:"aliases,omitempty"`
}

func (m *NetworkAttachmentConfig) Reset()                    { *m = NetworkAttachmentConfig{} }
func (*NetworkAttachmentConfig) ProtoMessage()               {}
func (*NetworkAttachmentConfig) Descriptor() ([]byte, []int) { return fileDescriptorSpecs, []int{9} }
...
func (this *NetworkSpec) GoString() string {
	...
	s = append(s, "Legacy: "+fmt.Sprintf("%#v", this.Legacy)+",\n")
	s = append(s, "}")
	return strings.Join(s, "")
}
...
var fileDescriptorSpecs = []byte{
	...
	,
}
