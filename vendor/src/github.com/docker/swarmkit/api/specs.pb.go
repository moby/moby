...
func (this *ContainerSpec) String() string {
	...
	s := strings.Join([]string{`&ContainerSpec{`,
		...
		`StopGracePeriod:` + strings.Replace(fmt.Sprintf("%v", this.StopGracePeriod), "Duration", "docker_cluster_api1.Duration", 1) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *ContainerSpec) Unmarshal(data []byte) error {
	...
	for iNdEx < l {
		...
		case 9:
			...
			if m.StopGracePeriod == nil {
				m.StopGracePeriod = &docker_cluster_api1.Duration{}
			}
...
var fileDescriptorSpecs = []byte{
	...
	,
}
