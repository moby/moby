...
type NetworkAttachment struct {
	...
	NodeID string                  `protobuf:"bytes,6,opt,name=node_id,json=nodeId,proto3" json:"node_id,omitempty"`
	Config NetworkAttachmentConfig `protobuf:"bytes,7,opt,name=config" json:"config"`
	Status AttachmentStatus        `protobuf:"bytes,8,opt,name=status" json:"status"`
}
...
func (this *NetworkAttachment) GoString() string {
	...
	s = append(s, "Meta: "+strings.Replace(this.Meta.GoString(), `&`, ``, 1)+",\n")
	s = append(s, "NodeID: "+fmt.Sprintf("%#v", this.NodeID)+",\n")
	s = append(s, "Config: "+strings.Replace(this.Config.GoString(), `&`, ``, 1)+",\n")
	s = append(s, "Status: "+strings.Replace(this.Status.GoString(), `&`, ``, 1)+",\n")
	s = append(s, "}")
	return strings.Join(s, "")
}
...
func (m *NetworkAttachment) MarshalTo(data []byte) (int, error) {
	...
	data[i] = 0x3a
	i++
	i = encodeVarintObjects(data, i, uint64(m.Config.Size()))
...
func (this *NetworkAttachment) String() string {
	...
	s := strings.Join([]string{`&NetworkAttachment{`,
		...
		`Meta:` + strings.Replace(strings.Replace(this.Meta.String(), "Meta", "Meta", 1), `&`, ``, 1) + `,`,
		`NodeID:` + fmt.Sprintf("%v", this.NodeID) + `,`,
		`Config:` + strings.Replace(strings.Replace(this.Config.String(), "NetworkAttachmentConfig", "NetworkAttachmentConfig", 1), `&`, ``, 1) + `,`,
...
var fileDescriptorObjects = []byte{
	...
	,
}
