...
import (
	...
	"github.com/moby/moby/daemon/internal/otelutil"
	"github.com/moby/moby/daemon/internal/sliceutil"
	"github.com/moby/moby/daemon/libnetwork/datastore"
	...
	"github.com/moby/moby/daemon/libnetwork/drivers/bridge/internal/iptabler"
	"github.com/moby/moby/daemon/libnetwork/drivers/bridge/internal/nftabler"
	"github.com/moby/moby/daemon/libnetwork/drvregistry"
	"github.com/moby/moby/daemon/libnetwork/internal/netiputil"
	"github.com/moby/moby/daemon/libnetwork/internal/nftables"
	"github.com/moby/moby/daemon/libnetwork/iptables"
	"github.com/moby/moby/daemon/libnetwork/netlabel"
	"github.com/moby/moby/daemon/libnetwork/netutils"
	"github.com/moby/moby/daemon/libnetwork/nlwrap"
	"github.com/moby/moby/daemon/libnetwork/ns"
	"github.com/moby/moby/daemon/libnetwork/options"
	"github.com/moby/moby/daemon/libnetwork/portmapperapi"
	"github.com/moby/moby/daemon/libnetwork/scope"
