...
import (
	...
	ctrd "github.com/moby/moby/daemon/containerd"
	...
	"github.com/moby/moby/daemon/internal/distribution"
	dmetadata "github.com/moby/moby/daemon/internal/distribution/metadata"
	...
	"github.com/moby/moby/daemon/internal/metrics"
	pluginexec "github.com/moby/moby/daemon/internal/plugin/executor/containerd"
	"github.com/moby/moby/daemon/libnetwork"
	"github.com/moby/moby/daemon/libnetwork/cluster"
	nwconfig "github.com/moby/moby/daemon/libnetwork/config"
	"github.com/moby/moby/daemon/libnetwork/ipamutils"
	"github.com/moby/moby/daemon/libnetwork/ipbits"
	dlogger "github.com/moby/moby/daemon/logger"
	"github.com/moby/moby/daemon/network"
	"github.com/moby/moby/daemon/pkg/authorization"
	"github.com/moby/moby/daemon/pkg/fileutils"
	"github.com/moby/moby/daemon/pkg/idtools"
	"github.com/moby/moby/daemon/pkg/plugin"
	"github.com/moby/moby/daemon/pkg/plugingetter"
	refstore "github.com/moby/moby/daemon/pkg/reference"
	"github.com/moby/moby/daemon/pkg/registry"
	"github.com/moby/moby/daemon/pkg/sysinfo"
	"github.com/moby/moby/daemon/snapshotter"
	"github.com/moby/moby/daemon/stats"
	volumesservice "github.com/moby/moby/daemon/volume/service"
