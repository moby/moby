...
// Inspect is the body of the "get network" http response message. It currently
// is an alias for [Summary], but may diverge in the future, as not all
// information may be included when listing networks.
