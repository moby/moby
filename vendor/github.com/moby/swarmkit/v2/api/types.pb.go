...
const (
	...
	// INTERRUPTED indicates the update stopped scheduling further
	// task replacements in response to a ServiceUpdateInterrupt
	// call. Tasks that were already replaced when the interrupt
	// took effect are left running (disposition HOLD) or reverted
	// to the pre-update spec (disposition REVERT). This is a
	// terminal state: it is reached instead of, never before,
	// COMPLETED, PAUSED or ROLLBACK_COMPLETED.
	UpdateStatus_INTERRUPTED UpdateStatus_UpdateState = 7
)
...
type UpdateStatus_Interrupt int32

const (
	// NONE indicates no interrupt has been requested for this
	// update.
	UpdateStatus_NONE UpdateStatus_Interrupt = 0
	// HOLD requests that the update stop scheduling further task
	// replacements once the tasks currently being replaced
	// finish or fail.
	UpdateStatus_HOLD UpdateStatus_Interrupt = 1
	// REVERT requests HOLD, followed by reverting any task
	// replacements already completed by this update back to the
	// specification the service ran before the update started.
	UpdateStatus_REVERT UpdateStatus_Interrupt = 2
)

var UpdateStatus_Interrupt_name = map[int32]string{
	0: "NONE",
	1: "HOLD",
	2: "REVERT",
}

var UpdateStatus_Interrupt_value = map[string]int32{
	"NONE":   0,
	"HOLD":   1,
	"REVERT": 2,
}

func (x UpdateStatus_Interrupt) String() string {
	return proto.EnumName(UpdateStatus_Interrupt_name, int32(x))
}

func (UpdateStatus_Interrupt) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_0b5eafd0404ded3d, []int{20, 1}
}
...
type UpdateStatus struct {
	...
	// RequestedInterrupt records a pending ServiceUpdateInterrupt
	// disposition that the updater has not yet acted on. It is set by
	// ServiceUpdateInterrupt and cleared once the updater has stopped
	// and (for REVERT) finished reverting completed replacements.
	RequestedInterrupt UpdateStatus_Interrupt `protobuf:"varint,5,opt,name=requested_interrupt,json=requestedInterrupt,proto3,enum=docker.swarmkit.v1.UpdateStatus_Interrupt" json:"requested_interrupt,omitempty"`
}
...
func init() {
	...
	proto.RegisterEnum("docker.swarmkit.v1.UpdateStatus_Interrupt", UpdateStatus_Interrupt_name, UpdateStatus_Interrupt_value)
...
var fileDescriptor_0b5eafd0404ded3d = []byte{
	...
	,
	...
	,
}
...
func (m *UpdateStatus) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.RequestedInterrupt != 0 {
		i = encodeVarintTypes(dAtA, i, uint64(m.RequestedInterrupt))
		i--
		dAtA[i] = 0x28
	}
	if len(m.Message) > 0 {
...
func (m *UpdateStatus) Size() (n int) {
	...
	if m.RequestedInterrupt != 0 {
		n += 1 + sovTypes(uint64(m.RequestedInterrupt))
	}
	return n
}
...
func (this *UpdateStatus) String() string {
	...
	s := strings.Join([]string{`&UpdateStatus{`,
		...
		`Message:` + fmt.Sprintf("%v", this.Message) + `,`,
		`RequestedInterrupt:` + fmt.Sprintf("%v", this.RequestedInterrupt) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *UpdateStatus) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field RequestedInterrupt", wireType)
			}
			m.RequestedInterrupt = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowTypes
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.RequestedInterrupt |= UpdateStatus_Interrupt(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
