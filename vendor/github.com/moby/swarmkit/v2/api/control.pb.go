...
type ServiceUpdateInterruptRequest_Disposition int32

const (
	// HOLD stops scheduling further task replacements. Task
	// replacements already completed are left running.
	ServiceUpdateInterruptRequest_HOLD ServiceUpdateInterruptRequest_Disposition = 0
	// REVERT does everything HOLD does, and additionally reverts
	// completed task replacements back to the specification the
	// service ran before the update started.
	ServiceUpdateInterruptRequest_REVERT ServiceUpdateInterruptRequest_Disposition = 1
)

var ServiceUpdateInterruptRequest_Disposition_name = map[int32]string{
	0: "HOLD",
	1: "REVERT",
}

var ServiceUpdateInterruptRequest_Disposition_value = map[string]int32{
	"HOLD":   0,
	"REVERT": 1,
}

func (x ServiceUpdateInterruptRequest_Disposition) String() string {
	return proto.EnumName(ServiceUpdateInterruptRequest_Disposition_name, int32(x))
}

func (ServiceUpdateInterruptRequest_Disposition) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_b37401dd08bf8930, []int{20, 0}
}
...
type ServiceUpdateInterruptRequest struct {
	ServiceID string `protobuf:"bytes,1,opt,name=service_id,json=serviceId,proto3" json:"service_id,omitempty"`
	// Version is the version of the service being interrupted. The
	// request is rejected with an out-of-sequence error if the service
	// has been written since this version.
	Version *Version `protobuf:"bytes,2,opt,name=version,proto3" json:"version,omitempty"`
	// Disposition controls what happens to task replacements that were
	// already completed when the interrupt takes effect.
	Disposition ServiceUpdateInterruptRequest_Disposition `protobuf:"varint,3,opt,name=disposition,proto3,enum=docker.swarmkit.v1.ServiceUpdateInterruptRequest_Disposition" json:"disposition,omitempty"`
}

func (m *ServiceUpdateInterruptRequest) Reset()      { *m = ServiceUpdateInterruptRequest{} }
func (*ServiceUpdateInterruptRequest) ProtoMessage() {}
func (*ServiceUpdateInterruptRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_b37401dd08bf8930, []int{20}
}
func (m *ServiceUpdateInterruptRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ServiceUpdateInterruptRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ServiceUpdateInterruptRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *ServiceUpdateInterruptRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ServiceUpdateInterruptRequest.Merge(m, src)
}
func (m *ServiceUpdateInterruptRequest) XXX_Size() int {
	return m.Size()
}
func (m *ServiceUpdateInterruptRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_ServiceUpdateInterruptRequest.DiscardUnknown(m)
}

var xxx_messageInfo_ServiceUpdateInterruptRequest proto.InternalMessageInfo

type ServiceUpdateInterruptResponse struct {
	Service *Service `protobuf:"bytes,1,opt,name=service,proto3" json:"service,omitempty"`
}

func (m *ServiceUpdateInterruptResponse) Reset()      { *m = ServiceUpdateInterruptResponse{} }
func (*ServiceUpdateInterruptResponse) ProtoMessage() {}
func (*ServiceUpdateInterruptResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_b37401dd08bf8930, []int{21}
}
func (m *ServiceUpdateInterruptResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ServiceUpdateInterruptResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ServiceUpdateInterruptResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *ServiceUpdateInterruptResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ServiceUpdateInterruptResponse.Merge(m, src)
}
func (m *ServiceUpdateInterruptResponse) XXX_Size() int {
	return m.Size()
}
func (m *ServiceUpdateInterruptResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_ServiceUpdateInterruptResponse.DiscardUnknown(m)
}

var xxx_messageInfo_ServiceUpdateInterruptResponse proto.InternalMessageInfo
...
func (*ListServicesRequest_Filters) Descriptor() ([]byte, []int) {
	return fileDescriptor_b37401dd08bf8930, []int{24, 0}
}
...
func (*ListServiceStatusesResponse_ServiceStatus) Descriptor() ([]byte, []int) {
	return fileDescriptor_b37401dd08bf8930, []int{27, 0}
}
...
func (*ListNetworksRequest_Filters) Descriptor() ([]byte, []int) {
	return fileDescriptor_b37401dd08bf8930, []int{34, 0}
}
...
func (*ListClustersRequest_Filters) Descriptor() ([]byte, []int) {
	return fileDescriptor_b37401dd08bf8930, []int{38, 0}
}
...
func (*ListSecretsRequest_Filters) Descriptor() ([]byte, []int) {
	return fileDescriptor_b37401dd08bf8930, []int{47, 0}
}
...
func (*ListConfigsRequest_Filters) Descriptor() ([]byte, []int) {
	return fileDescriptor_b37401dd08bf8930, []int{57, 0}
}
...
func (*ListResourcesRequest_Filters) Descriptor() ([]byte, []int) {
	return fileDescriptor_b37401dd08bf8930, []int{77, 0}
}
...
func (*ListVolumesRequest_Filters) Descriptor() ([]byte, []int) {
	return fileDescriptor_b37401dd08bf8930, []int{85, 0}
}
...
func (*RemoveVolumeRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_b37401dd08bf8930, []int{87}
}
...
func (*RemoveVolumeResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_b37401dd08bf8930, []int{88}
}
...
func init() {
	...
	proto.RegisterEnum("docker.swarmkit.v1.ServiceUpdateInterruptRequest_Disposition", ServiceUpdateInterruptRequest_Disposition_name, ServiceUpdateInterruptRequest_Disposition_value)
	...
	proto.RegisterType((*ServiceUpdateInterruptRequest)(nil), "docker.swarmkit.v1.ServiceUpdateInterruptRequest")
	proto.RegisterType((*ServiceUpdateInterruptResponse)(nil), "docker.swarmkit.v1.ServiceUpdateInterruptResponse")
...
var fileDescriptor_b37401dd08bf8930 = []byte{
	...
	,
}
...
func (p *authenticatedWrapperControlServer) ServiceUpdateInterrupt(ctx context.Context, r *ServiceUpdateInterruptRequest) (*ServiceUpdateInterruptResponse, error) {

	if err := p.authorize(ctx, []string{"swarm-manager"}); err != nil {
		return nil, err
	}
	return p.local.ServiceUpdateInterrupt(ctx, r)
}
...
func (m *ServiceUpdateInterruptRequest) Copy() *ServiceUpdateInterruptRequest {
	if m == nil {
		return nil
	}
	o := &ServiceUpdateInterruptRequest{}
	o.CopyFrom(m)
	return o
}

func (m *ServiceUpdateInterruptRequest) CopyFrom(src interface{}) {

	o := src.(*ServiceUpdateInterruptRequest)
	*m = *o
	if o.Version != nil {
		m.Version = &Version{}
...
func (m *ServiceUpdateInterruptResponse) Copy() *ServiceUpdateInterruptResponse {
	if m == nil {
		return nil
	}
	o := &ServiceUpdateInterruptResponse{}
	o.CopyFrom(m)
	return o
}

func (m *ServiceUpdateInterruptResponse) CopyFrom(src interface{}) {

	o := src.(*ServiceUpdateInterruptResponse)
	*m = *o
	if o.Service != nil {
		m.Service = &Service{}
		github_com_moby_swarmkit_v2_api_deepcopy.Copy(m.Service, o.Service)
...
type ControlClient interface {
	...
	// ServiceUpdateInterrupt interrupts a service update or rollback that
	// is currently in progress. It stops the update from scheduling
	// further task replacements once the tasks currently being replaced
	// finish or fail, and moves UpdateStatus.State to INTERRUPTED. If
	// there is no update in progress, this call is a no-op that succeeds.
	ServiceUpdateInterrupt(ctx context.Context, in *ServiceUpdateInterruptRequest, opts ...grpc.CallOption) (*ServiceUpdateInterruptResponse, error)
...
func (c *controlClient) ServiceUpdateInterrupt(ctx context.Context, in *ServiceUpdateInterruptRequest, opts ...grpc.CallOption) (*ServiceUpdateInterruptResponse, error) {
	out := new(ServiceUpdateInterruptResponse)
	err := c.cc.Invoke(ctx, "/docker.swarmkit.v1.Control/ServiceUpdateInterrupt", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ControlServer interface {
	...
	// finish or fail, and moves UpdateStatus.State to INTERRUPTED. If
	// there is no update in progress, this call is a no-op that succeeds.
	ServiceUpdateInterrupt(context.Context, *ServiceUpdateInterruptRequest) (*ServiceUpdateInterruptResponse, error)
	// ListServiceStatuses returns a `ListServiceStatusesResponse` with the
	// status of the requested services, formed by computing the number of
	// running vs desired tasks. It is provided as a shortcut or helper method,
	// which allows a client to avoid having to calculate this value by listing
...
func (*UnimplementedControlServer) ServiceUpdateInterrupt(ctx context.Context, req *ServiceUpdateInterruptRequest) (*ServiceUpdateInterruptResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ServiceUpdateInterrupt not implemented")
}
...
func _Control_ServiceUpdateInterrupt_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ServiceUpdateInterruptRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ControlServer).ServiceUpdateInterrupt(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/docker.swarmkit.v1.Control/ServiceUpdateInterrupt",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ControlServer).ServiceUpdateInterrupt(ctx, req.(*ServiceUpdateInterruptRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Control_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ServiceUpdateInterrupt",
			Handler:    _Control_ServiceUpdateInterrupt_Handler,
		},
		{
...
func (m *ServiceUpdateInterruptRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *ServiceUpdateInterruptRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ServiceUpdateInterruptRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if m.Disposition != 0 {
		i = encodeVarintControl(dAtA, i, uint64(m.Disposition))
		i--
		dAtA[i] = 0x18
	}
	if m.Version != nil {
...
func (m *ServiceUpdateInterruptResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *ServiceUpdateInterruptResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ServiceUpdateInterruptResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (p *raftProxyControlServer) ServiceUpdateInterrupt(ctx context.Context, r *ServiceUpdateInterruptRequest) (*ServiceUpdateInterruptResponse, error) {
	...
	resp, err := NewControlClient(conn).ServiceUpdateInterrupt(modCtx, r)
	if err != nil {
		if !strings.Contains(err.Error(), "is closing") && !strings.Contains(err.Error(), "the connection is unavailable") && !strings.Contains(err.Error(), "connection error") {
			return resp, err
		}
		...
		return NewControlClient(conn).ServiceUpdateInterrupt(modCtx, r)
	}
	return resp, err
}
...
func (m *ServiceUpdateInterruptRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	...
	if m.Disposition != 0 {
		n += 1 + sovControl(uint64(m.Disposition))
	}
	return n
}

func (m *ServiceUpdateInterruptResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (this *ServiceUpdateInterruptRequest) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&ServiceUpdateInterruptRequest{`,
		`ServiceID:` + fmt.Sprintf("%v", this.ServiceID) + `,`,
		`Version:` + strings.Replace(fmt.Sprintf("%v", this.Version), "Version", "Version", 1) + `,`,
		`Disposition:` + fmt.Sprintf("%v", this.Disposition) + `,`,
		`}`,
	}, "")
	return s
}
func (this *ServiceUpdateInterruptResponse) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&ServiceUpdateInterruptResponse{`,
		`Service:` + strings.Replace(fmt.Sprintf("%v", this.Service), "Service", "Service", 1) + `,`,
		`}`,
	}, "")
	return s
...
func (m *ServiceUpdateInterruptRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ServiceUpdateInterruptRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ServiceUpdateInterruptRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 3:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Disposition |= ServiceUpdateInterruptRequest_Disposition(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *ServiceUpdateInterruptResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ServiceUpdateInterruptResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ServiceUpdateInterruptResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
