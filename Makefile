...
DOCKER_RUN_DOCKER := docker run --rm -it --privileged -v $(CURDIR):/go/src/github.com/docker/docker -e TESTFLAGS -e TESTDIRS -e DOCKER_GRAPHDRIVER -e DOCKER_EXECDRIVER $(DOCKER_MOUNT) "$(DOCKER_IMAGE)"
