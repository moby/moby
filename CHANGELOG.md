...
+ Add links example
+ Add documentaiton regaring amassabor pattern
...
- `docker build` now check for that the dockerfile exists
- `docker attach` now returns the correct exit code
- Remove the name entry when the container does not exists
