	...
	syscalls := []*Syscall{
		...
		},
		{
			...
			Args: []*specs.LinuxSeccompArg{
				{
					Index:    0,
					Value:    unix.CLONE_NEWNS | unix.CLONE_NEWUTS | unix.CLONE_NEWIPC | unix.CLONE_NEWPID | unix.CLONE_NEWNET | unix.CLONE_NEWCGROUP,
					ValueTwo: 0,
...
// DefaultProfileWithoutUserNamespaces defines the allowed syscalls for the default seccomp profile,
// except that the unprivileged creation of user namespaces is disallowed.
