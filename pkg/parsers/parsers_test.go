...
func TestParseHost(t *testing.T) {
	...
	invalids := map[string]string{
		...
		"tcp:a.b.c.d:any":       "Invalid bind address format: tcp:a.b.c.d:any",
		"http://":               "Invalid proto, expected http: ",
		"http://a.b.c.d:any":    "Invalid bind address format: a.b.c.d:any",
		"https://":              "Invalid proto, expected https: ",
		"https://a.b.c.d:any":   "Invalid bind address format: a.b.c.d:any",
		"https://a.b.c.d:80:80": "Invalid bind address format: a.b.c.d:80:80",
	...
	valids := map[string]string{
		...
		"tcp://0.0.0.1:8888":            "tcp://0.0.0.1:8888",
		"http://:7777":                  "http://127.0.0.1:7777",
		"http://0.0.0.1:8888":           "http://0.0.0.1:8888",
		"http://0.0.0.1:8888/some/path": "http://0.0.0.1:8888/some/path",
		"http://0.0.0.1":                "http://0.0.0.1:80",
		"http://domain.tld":             "http://domain.tld:80",
		"http://domain.tld/some/path":   "http://domain.tld:80/some/path",
		"https://:7777":                 "https://127.0.0.1:7777",
		"https://0.0.0.1:8888":          "https://0.0.0.1:8888",
		"https://0.0.0.1":               "https://0.0.0.1:443",
		"https://domain.tld/some/path":  "https://domain.tld:443/some/path",
