...
func (s *DockerSuite) TestChrootTarUntar(c *check.C) {
...
// local images)
func (s *DockerSuite) TestChrootUntarWithHugeExcludesList(c *check.C) {
...
func (s *DockerSuite) TestChrootUntarEmptyArchive(c *check.C) {
	...
	if err := Untar(nil, tmpdir, nil); err == nil {
		c.Fatal("expected error on empty archive")
	}
}
...
func (s *DockerSuite) TestChrootTarUntarWithSymlink(c *check.C) {
...
func (s *DockerSuite) TestChrootCopyWithTar(c *check.C) {
	// TODO Windows: Figure out why this is failing
	if runtime.GOOS == "windows" {
		c.Skip("Failing on Windows")
	}
...
func (s *DockerSuite) TestChrootCopyFileWithTar(c *check.C) {
	...
	if err := CopyFileWithTar(src, dest); err == nil {
		c.Fatal("Expected error on copying directory")
	}
...
func (s *DockerSuite) TestChrootUntarPath(c *check.C) {
	// TODO Windows: Figure out why this is failing
	if runtime.GOOS == "windows" {
		c.Skip("Failing on Windows")
	}
	...
	if err := UntarPath(src, dest); err == nil {
		c.Fatal("Expected error on untaring a directory")
	}
...
func (s *DockerSuite) TestChrootUntarEmptyArchiveFromSlowReader(c *check.C) {
...
func (s *DockerSuite) TestChrootApplyEmptyArchiveFromSlowReader(c *check.C) {
...
func (s *DockerSuite) TestChrootApplyDotDotFile(c *check.C) {
