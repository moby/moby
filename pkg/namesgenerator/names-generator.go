...
var (
	...
	right = [...]string{
		...
		// Kimishige Ishizaka - Japanese scientist and immunologist who co-discovered the antibody class Immunoglobulin E. https://en.wikipedia.org/wiki/Kimishige_Ishizaka
		"kimishige",
