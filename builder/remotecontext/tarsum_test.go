...
func TestHashFile(t *testing.T) {
	...
	if expected, actual := "55dfeb344351ab27f59aa60ebb0ed12025a2f2f4677bf77d26ea7a671274a9ca", sum; expected != actual {
...
func TestHashSubdir(t *testing.T) {
	...
	if expected, actual := "74a3326b8e766ce63a8e5232f22e9dd895be647fb3ca7d337e5e0a9b3da8ef28", sum; expected != actual {
		t.Fatalf("invalid checksum. expected %s, got %s", expected, actual)
	}
}
