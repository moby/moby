...
type Backend interface {
	...
	// Resolve image resolves a ref into a descriptor
	ResolveImage(context.Context, string) (ocispec.Descriptor, error)

	ResolveRuntimeConfig(context.Context, ocispec.Descriptor) ([]byte, error)

	// CommitBuildStep creates a new Docker image from the config generated by
	// a build step.
	CommitBuildStep(context.Context, backend.CommitConfig) (ocispec.Descriptor, error)
...
type ImageBackend interface {
	GetImageAndReleasableLayer(ctx context.Context, refOrID string, opts backend.GetImageAndLayerOptions) (*ocispec.Descriptor, ROLayer, error)
}
