...
type Backend interface {
	...
	CreateImage(ctx context.Context, config []byte, parent string) (Image, error)
...
type ImageCache interface {
	...
	GetCache(ctx context.Context, parentID string, cfg *container.Config) (imageID string, err error)
}
