...
- [:twisted\_rightwards\_arrows: Pull requests](#twisted_rightwards_arrows-pull-requests)
- [:dart: Milestones](#dart-milestones)
  - [Project roadmap](#project-roadmap)
- [:bookmark: Tags](#bookmark-tags)
- [:herb: Branches](#herb-branches)
  - [Maintenance status](#maintenance-status)
  - [Backports](#backports)
- [:bar\_chart: Workflow and tracking](#bar_chart-workflow-and-tracking)
- [:ambulance:  Triage](#ambulance--triage)
    - [Content review](#content-review)
    - [Classification and labeling](#classification-and-labeling)
  - [Project backlog](#project-backlog)
- [:pushpin: Projects](#pushpin-projects)
- [:speech\_balloon: Discussions](#speech_balloon-discussions)
- [:gear: Workflow automation](#gear-workflow-automation)
  - [Exempting an issue/PR from stale bot processing](#exempting-an-issuepr-from-stale-bot-processing)
- [:earth\_americas: Public APIs](#earth_americas-public-apis)
...
Issues and pull requests tagged with the `roadmap` label are high level roadmap
items. They represent tasks and/or features that the community wants completed.
Related work items can reference their related roadmap item to help track
progress.

To find the roadmap items currently planned for the project you can filter on
the `roadmap` label.

[Search Roadmap Items](https://github.com/moby/moby/issues?q=is%3Aopen+is%3Aissue+label%3Aroadmap)

After searching for roadmap items you can view what milestone they are scheduled
to be completed in along with the progress.

[View Milestones](https://github.com/moby/moby/milestones)
...
## :bar_chart: Workflow and tracking
...
This project maintains a backlog -— a holding area for issues and pull requests
that have been approved by maintainers but are not yet scheduled for release.
When a work item is assigned to a milestone, it moves into planning, indicating
that it has been scheduled for a release.  

Backlog items will have an [`accepted`](https://github.com/moby/moby/issues?q=sort%3Aupdated-desc+is%3Aopen+label%3Aaccepted) label.
...
insight into the project roadmap. Read the project documentation for more
