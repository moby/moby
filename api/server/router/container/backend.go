...
type stateBackend interface {
	ContainerCreate(config types.ContainerCreateConfig, validateHostname bool) (container.CreateCreatedBody, error)
	...
	ContainerUpdate(name string, hostConfig *container.HostConfig, validateHostname bool) (container.UpdateOKBody, error)
