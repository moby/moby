...
type Backend interface {
	...
	Get(ctx context.Context, name string, opts ...volumeopts.GetOption) (*volume.Volume, error)
	Create(ctx context.Context, name, driverName string, opts ...volumeopts.CreateOption) (*volume.Volume, error)
	Remove(ctx context.Context, name string, opts ...volumeopts.RemoveOption) error
