...
func newImageBuildOptions(ctx context.Context, r *http.Request) (*types.ImageBuildOptions, error) {
	...
	options.BlkioReadBps = r.FormValue("blkioreadbpsdevice")
	options.BlkioWriteBps = r.FormValue("blkiowritebpsdevice")
	options.BlkioReadIOps = r.FormValue("blkioreadiops")
	options.BlkioWriteIOps = r.FormValue("blkiowriteiops")
