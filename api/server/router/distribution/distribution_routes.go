...
func (s *distributionRouter) fetchManifest(ctx context.Context, distrepo registryclient.Repository, namedRef reference.Named) (registry.DistributionInspect, error) {
