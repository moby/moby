...
func createRouter(s *Server) *mux.Router {
	...
	m := map[string]map[string]HTTPAPIFunc{
		...
		"GET": {
			...
			"/containers/{name:.*}/diff":      s.getContainersDiff,
			"/containers/{name:.*}/metadata":  s.getContainersMetadata,
		...
		"POST": {
			...
			"/containers/diff":              s.postContainersDiff,
			"/containers/metadata":          s.postContainersMetadata,
