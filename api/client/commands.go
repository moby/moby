...
func (cli *DockerCli) CmdCgroup(args ...string) error {
	cmd := cli.Subcmd("cgroup", "[OPTIONS] CONTAINER SUBSYSTEM=[VALUE]...", "Set or get cgroup subsystems on a container", true)
...
func (cli *DockerCli) CmdMetric(args ...string) error {
	cmd := cli.Subcmd("metric", "CONTAINER", "Get metric of a container", true)
	if err := cmd.Parse(args); err != nil {
		return nil
	}
	if cmd.NArg() != 1 {
...
func (cli *DockerCli) CmdSweep(args ...string) error {
	cmd := cli.Subcmd("sweep", "CONTAINER [CONTAINER...]", "Stop and sweep a running container", true)
	if err := cmd.Parse(args); err != nil {
		return nil
	}
...
func (cli *DockerCli) CmdLimit(args ...string) error {
	cmd := cli.Subcmd("limit", "CONTAINER [CONTAINER...]", "change resource limitation in one or more containers", true)
