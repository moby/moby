...
func (cli *DockerCli) CmdBuild(args ...string) error {
	...
	breakCache := cmd.String([]string{"#break-cache", "-break-cache"}, false, "Ignore cache for ADD and RUN lines matching provided POSIX ERE regexp string")
	...
	if *noCache && *breakCache {
		return fmt.Errorf("Can't specify both --no-cache and --break-cache")
	}
