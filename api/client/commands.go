...
func (cli *DockerCli) CmdBuild(args ...string) error {
	...
	for _, definition := range *macroDefinitions {
		item := strings.SplitN(definition, "=", 2)

		if len(item) != 2 {
			return fmt.Errorf("invalid macro definition: %s", definition)
		}
