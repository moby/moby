...
func (cli *DockerCli) CmdBuild(args ...string) error {
	...
	quiet := cmd.Bool([]string{"q", "-quiet"}, false, "Suppress the verbose output generated by the containers")
	verbose := cmd.String([]string{"v", "-verbose"}, "", "Specify the verbosity of the output generated")
