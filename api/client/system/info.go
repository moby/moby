...
func runInfo(dockerCli *client.DockerCli) error {
	...
	fmt.Fprintf(dockerCli.Out(), "Containers since daemon start:\n")
	fmt.Fprintf(dockerCli.Out(), " Created: %d\n", info.ContainersSinceStartCreated)
	fmt.Fprintf(dockerCli.Out(), " Exited: %d\n", info.ContainersSinceStartExited)
	fmt.Fprintf(dockerCli.Out(), " Paused: %d\n", info.ContainersSinceStartPaused)
	fmt.Fprintf(dockerCli.Out(), " Restored: %d\n", info.ContainersSinceStartRestored)
	fmt.Fprintf(dockerCli.Out(), " Started: %d\n", info.ContainersSinceStartStarted)
	fmt.Fprintf(dockerCli.Out(), " Unpaused: %d\n", info.ContainersSinceStartUnpaused)
