...
type StatsResponseReader = container.StatsResponseReader
...
func NewStateStatus(exitCode int, err error) container.StateStatus {
	return container.NewStateStatus(exitCode, err)
}
