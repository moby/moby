...
func (n *network) setupSubnetSandbox(s *subnet, brName, vxlanName string) error {
	...
	if _, err := sbox.AddInterface(brName, "br", osl.WithIPv4Address(s.gwIP), osl.WithIsBridge(true)); err != nil {
	...
	if _, err := sbox.AddInterface(vxlanName, "vxlan", osl.WithMaster(brName)); err != nil {
