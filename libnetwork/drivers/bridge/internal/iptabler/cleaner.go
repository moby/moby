...
func (ic iptablesCleaner) DelLink(ctx context.Context, nc firewaller.NetworkConfig, parentIP, childIP netip.Addr, ports []types.TransportPort) {
	// Nothing to do, legacy link rules are all in user-defined chains that have
