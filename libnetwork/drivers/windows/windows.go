...
// IsAdoptableNetworkType returns true if HNS networks of this type should be
// ignored on startup when searching for networks created outside Docker to adopt
// (by adding them to the network store).
