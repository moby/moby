...
// updateExternalConnectivity configures Endpoint ep when it becomes the gateway
...
// Sandbox's OS-specific code takes care of that. This is just about network driver
// configuration.)
//
...
// specified.
func (sb *Sandbox) updateExternalConnectivity(ctx context.Context, ep *Endpoint, gwepBefore4, gwepBefore6 *Endpoint) (retErr error) {
