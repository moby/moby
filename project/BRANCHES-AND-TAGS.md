...
When possible, Docker Engine releases are cut directly from `master`. Release branches are created when ongoing development on `master` would conflict with patch releases.
...
| docker-28.x                 | @cpuguy83                                      | Maintained            | N/A                         | [Microsoft][msft]                         |
| 27.x                        |                                                | Unmaintained          |                             |                                           |
| 26.1                        |                                                | Unmaintained          |                             |                                           |
| 26.0                        |                                                | Unmaintained          |                             |                                           |
