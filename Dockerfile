...
RUN curl -fsSL "https://golang.org/dl/go${GO_VERSION}.linux-amd64.tar.gz" \
	| tar -xzC /usr/local
# Fix archive/tar issue in go1.9 (https://github.com/golang/go/issues/21005)
RUN curl -fsSl https://github.com/golang/go/commit/01e45c736882754ca785b5a802ec0866a6544f8b.patch \
	| git apply -p1 --directory /usr/local/go --unsafe-paths -
