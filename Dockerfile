...
RUN --mount=from=containerd-src,src=/usr/src/containerd,rw \
  ...
  make $([ "$DOCKER_LINKMODE" = "static" ] && echo "STATIC=1") bin/containerd
  make $([ "$DOCKER_LINKMODE" = "static" ] && echo "STATIC=1") bin/containerd-shim-runc-v2
  make $([ "$DOCKER_LINKMODE" = "static" ] && echo "STATIC=1") bin/ctr
  ...
  xx-verify $([ "$DOCKER_LINKMODE" = "static" ] && echo "--static") bin/ctr
  mv bin /out
EOT
