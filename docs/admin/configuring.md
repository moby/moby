...
can be located at `/var/log/upstart/docker.log`
    ...
    INFO[0000] Docker daemon commit=1b09a95-unsupported storage-driver=aufs version=1.11.0-dev
...
be viewed using `journalctl -u docker`
    ...
    May 06 00:22:06 localhost.localdomain docker[2495]: time="2015-05-06T00:22:06Z" level="info" msg="Docker daemon commit=1b09a95-unsupported storage-driver=aufs version=1.11.0-dev"
