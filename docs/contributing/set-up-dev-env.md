...
5. List the contents of the current directory (`/go/src/github.com/moby/moby/v2`).

   You should see the image's source from the  `/go/src/github.com/moby/moby/v2`
   directory.
