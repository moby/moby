...
#SSH Login with putty using the  default private key generated by boot2docker
   download puttyget -  http://the.earth.li/~sgtatham/putty/latest/x86/puttygen.exe
   open the private key from %HOMEPATH%\.ssh\id_boot2docker
   save private key and use the saved private key to ssh to docker@127.0.0.0:2202
