...
Note: If you have used boot2docker on OSX you'll need to get the IP of the virtual host instead of using localhost. You can do this by running the following in the boot2docker shell.
