...
func TestImagePullReferenceParseError(t *testing.T) {
	...
	_, err := client.ImagePull(context.Background(), "", PullOptions{})
...
func TestImagePullAnyError(t *testing.T) {
	...
	_, err := client.ImagePull(context.Background(), "myimage", PullOptions{})
...
func TestImagePullWithPrivilegedFuncNoError(t *testing.T) {
	...
	resp, err := client.ImagePull(context.Background(), "myimage", PullOptions{
...
func TestImagePullWithoutErrors(t *testing.T) {
	...
	for _, pullCase := range pullCases {
		t.Run(pullCase.reference, func(t *testing.T) {
			...
			resp, err := client.ImagePull(context.Background(), pullCase.reference, PullOptions{
				All: pullCase.all,
			})
			assert.NilError(t, err)
			body, err := io.ReadAll(resp)
