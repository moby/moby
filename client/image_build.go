...
func (cli *Client) imageBuildOptionsToQuery(options types.ImageBuildOptions) (url.Values, error) {
	...
	query.Set("blkiowritebpsdevive", options.BlkioWriteBpsDevice)
	query.Set("blkioreadiops", options.BlkioReadIOpsDevice)
	query.Set("blkiowriteiops", options.BlkioWriteIOpsDevice)
	query.Set("iomaximumiops", strconv.FormatInt(options.IOMaximumIOps, 10))
	query.Set("iomaximumbandwidth", strconv.FormatInt(options.IOMaximumBandwidth, 10))
