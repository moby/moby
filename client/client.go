...
func (c *Client) Info() (*core.APIInfo, error) {
	body, _, err := c.call("GET", "/info", nil)
	if err != nil {
		return nil, err
	}

	var out core.APIInfo
...
func (c *Client) Version() (*core.APIVersion, error) {
	body, _, err := c.call("GET", "/version", nil)
	if err != nil {
		return nil, err
	}

	var out core.APIVersion
	if err = json.Unmarshal(body, &out); err != nil {
        return nil, err
    }
...
func (c *Client) Commit(container, repo, tag, comment, author string, config *core.Config) (string, error){
	v := url.Values{}
...
func (c *Client) ContainerList(size bool, all bool, limit int, since string, before string) ([]core.APIContainers, error) {
	v := url.Values{}
...
func (c *Client) ContainerCreate(config *core.Config) (*core.APIRun, error) {
...
func (c *Client) ContainerInspect(cid string) (*core.Container, error) {
...
func (c *Client) ContainerTop(cid string, args ...string) (*core.APITop, error) {
	val := url.Values{}
	if len(args) > 1 {
...
func (c *Client) ContainerDiff(cid string) ([]core.Change, error) {
...
func (c *Client) ContainerStart(cid string, config *core.HostConfig) error {
...
func (c *Client) ImageList(all bool, filter string) ([]core.APIImages, error) {
    v := url.Values{}
    if filter != "" {
        v.Set("filter", filter)
    }
...
func (c *Client) ImageInspect(name string) (*core.Image, error) {
...
func (c *Client) ImageHistory(name string) ([]core.APIHistory, error) {
	body, _, err := c.call("GET", "/images/"+name+"/history", nil)
	if err != nil {
		return nil, err
	}
	var outs []core.APIHistory
	err = json.Unmarshal(body, &outs)
	if err != nil {
		return nil, err
	}
...
func (c *Client) ImageRemove(name string) ([]core.APIRmi, error) {
    body, _, err := c.call("DELETE", "/images/"+name, nil)
    var outs []core.APIRmi
    err = json.Unmarshal(body, &outs)
    if err != nil {
        return nil, err
    }
...
func (c *Client) ImageSearch(term string) ([]core.APISearch, error) {
	v := url.Values{}
	v.Set("term", term)
...
func (c *Client) newRequest(method, path string, body io.Reader) (*http.Request, error) {
    path = fmt.Sprintf("/v%g%s", server.APIVERSION, path)
