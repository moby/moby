...
func AttributeListVar(values *[]string, names []string, usage string) {
	flag.Var(newListOptsRef(values, ValidateAttribute), names, usage)
}
...
func ValidateAttribute(val string) (string, error) {
