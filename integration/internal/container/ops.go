...
func WithPortMap(pm map[container.PortRangeProto][]container.PortBinding) func(*TestContainerConfig) {
	return func(c *TestContainerConfig) {
		c.HostConfig.PortBindings = map[container.PortRangeProto][]container.PortBinding{}
		for p, b := range pm {
