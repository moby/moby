...
func TestDaemonProxy(t *testing.T) {
	...
	t.Run("environment variables", func(t *testing.T) {
		...
		_, err := c.ImagePull(ctx, "example.org:5000/some/image:latest", client.PullOptions{})
		...
		_, err = c.ImagePull(ctx, "example.com/some/image:latest", client.PullOptions{})
		assert.ErrorContains(t, err, "", "pulling should have failed")
	...
	t.Run("command-line options", func(t *testing.T) {
		...
		_, err := c.ImagePull(ctx, "example.org:5001/some/image:latest", client.PullOptions{})
		assert.ErrorContains(t, err, "", "pulling should have failed")
	...
	t.Run("configuration file", func(t *testing.T) {
		...
		_, err := c.ImagePull(ctx, "example.org:5002/some/image:latest", client.PullOptions{})
		assert.ErrorContains(t, err, "", "pulling should have failed")
