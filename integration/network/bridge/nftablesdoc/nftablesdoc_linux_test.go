...
type ctrDesc struct {
	name         string
	portMappings map[containertypes.PortRangeProto][]containertypes.PortBinding
}
	...
	},
	{
		...
		networks: []networkDesc{{
			...
			containers: []ctrDesc{
				{
					name:         "c1",
					portMappings: map[containertypes.PortRangeProto][]containertypes.PortBinding{"80/tcp": {{HostPort: "8080"}}},
				},
			},
		}},
	},
	...
	*/
	{
		...
		networks: []networkDesc{{
			...
			containers: []ctrDesc{
				{
					name:         "c1",
					portMappings: map[containertypes.PortRangeProto][]containertypes.PortBinding{"80/tcp": {{HostIP: "127.0.0.1", HostPort: "8080"}}},
				},
			},
		}},
	},
