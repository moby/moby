...
complete -c docker -f -n '__fish_docker_no_subcommand' -l dns-option -d 'Force Docker to use specific DNS options'
...
complete -c docker -A -f -n '__fish_seen_subcommand_from create' -l dns-option -d "Set custom DNS options (Use --dns-option='' if you don't wish to set options)"
...
complete -c docker -A -f -n '__fish_seen_subcommand_from run' -l dns-option -d "Set custom DNS options (Use --dns-option='' if you don't wish to set options)"
