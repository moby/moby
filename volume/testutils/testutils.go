...
func (NoopVolume) Mount(_ string, _ map[string]string) (string, error) { return "noop", nil }
...
// Mount mounts the volume in the container
func (FakeVolume) Mount(_ string, _ map[string]string) (string, error) { return "fake", nil }
