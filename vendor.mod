...
replace (
	...
	// FIXME: testing "0.10_backport_image_spec_no_literal" branch from https://github.com/moby/buildkit/pull/3106
	github.com/moby/buildkit => github.com/thaJeztah/buildkit v0.0.0-20220910111810-bce5213270bb
