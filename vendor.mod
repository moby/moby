...
replace (
	...
	// Trying https://github.com/moby/buildkit/pull/3010
	//
	// looks like go.mod doesn't allow branch-names as reference if they contain a `/` (pranavp/azblob-rebase),
	// so using commit https://github.com/amrmahdi/buildkit/commit/1ef0b534d3f4c3ae7c4fce9e1fa33c1cc58ee463
	//
	// + go mod tidy -modfile vendor.mod -compat 1.17
	//   	//go: errors parsing go.mod:
	//   	//vendor.mod:168:2: replace github.com/amrmahdi/buildkit: version "pranavp/azblob-rebase" invalid: version "pranavp/azblob-rebase" invalid: disallowed version string
	github.com/moby/buildkit => github.com/amrmahdi/buildkit v0.10.1-0.20220819015226-1ef0b534d3f4
