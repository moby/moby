...
replace (
	...
	github.com/moby/moby/api => github.com/moby/moby/api v1.52.0-alpha.1.0.20250822212749-41dd81192699 // master
	github.com/moby/moby/client => github.com/moby/moby/client v0.1.0-alpha.0.0.20250822212749-41dd81192699 // master
)
