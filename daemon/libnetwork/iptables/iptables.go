...
//
// Since iptables v1.4.22, iptables-nft maps ENOENT from nft_rule_delete
// to this diagnostic:
//
//	iptables: Bad rule (does a matching rule exist in that chain?).
//
// see: https://git.netfilter.org/iptables/tree/iptables/nft.c?id=7bc5f6c133bf38c696dc8c14cb479167711437c2#n2360
// ref: https://git.netfilter.org/iptables/commit/?id=7bc5f6c133bf38c696dc8c14cb479167711437c2
func isRuleNotFoundError(err error) bool {
	return err != nil && strings.Contains(err.Error(), "Bad rule (does a matching rule exist in that chain?)")
}
