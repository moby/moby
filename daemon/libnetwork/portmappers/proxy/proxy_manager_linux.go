...
// ProxyManager is a struct that manages the manages userland proxies.
...
// StartProxy starts the proxy process
...
// Stop stops the proxy process. It returns nil if the proxy is already stopped.
