...
//
// Debian 13 ships iptables v1.8.11, which fixed an iptables-nft bug where
// querying a non-existent chain could report it as incompatible instead of
// returning the usual "No chain/target/match by that name" diagnostic.
//
