...
// TestBulkSyncFromInactiveNodeRemembered checks that an unsolicited bulk sync
// from a node we consider failed (as happens across an asymmetric partition)
// is merged and remembered, while the reply to it is skipped.
