...
func TestTable(t *testing.T) {
	...
	applyAndCheck(t, tbl4, Modifier{}, t.Name()+"_created4.golden")
	applyAndCheck(t, tbl6, Modifier{}, t.Name()+"_created6.golden")
}
...
func TestChain(t *testing.T) {
	...
	// Update nftables and check what happened.
	applyAndCheck(t, tbl, tm, t.Name()+"_created.golden")
	...
	// Update nftables and check what happened.
	applyAndCheck(t, tbl, tm, t.Name()+"_modified.golden")
	...
	// Update nftables and check what happened.
	applyAndCheck(t, tbl, tm, t.Name()+"_deleted.golden")
}
...
func TestSetBaseChainPolicy(t *testing.T) {
	...
	applyAndCheck(t, tbl, tm, t.Name()+"_accept.golden")
...
func TestIgnoreExist(t *testing.T) {
	...
	applyAndCheck(t, tbl, tmDel, t.Name()+"_deleted.golden")
...
func TestVMap(t *testing.T) {
	...
	// Update nftables and check what happened.
	applyAndCheck(t, tbl, tmRev, t.Name()+"_deleted.golden")
}
...
func TestSet(t *testing.T) {
	...
	// Update nftables and check what happened.
	applyAndCheck(t, tbl4, tm4, t.Name()+"_created4.golden")
	applyAndCheck(t, tbl6, tm6, t.Name()+"_created6.golden")

	// Delete elements.
	applyAndCheck(t, tbl4, tm4.Reverse(), t.Name()+"_deleted4.golden")
	applyAndCheck(t, tbl6, tm6.Reverse(), t.Name()+"_deleted6.golden")
}
...
func TestReload(t *testing.T) {
	...
	applyAndCheck(t, tbl, tm, t.Name()+"_recovered.golden")
}
