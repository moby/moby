...
func (i *ImageService) UpdateConfig(maxDownloads, maxUploads int) {
	log.G(context.TODO()).Warn("max downloads and uploads is not yet implemented with the c8dstore store")
}
...
func (i *ImageService) GetContainerLayerSize(ctx context.Context, containerID string) (int64, int64, error) {
	...
	// TODO(thaJeztah): include content-store size for the image (similar to "GET /gdstore/json")
