...
func (daemon *Daemon) containerDiskUsage(ctx context.Context) (*types.ContainerDiskUsage, error) {
	res, _, err := daemon.usageContainers.Do(ctx, struct{}{}, func(ctx context.Context) (*types.ContainerDiskUsage, error) {
		...
		du := &types.ContainerDiskUsage{Items: containers}
...
func (daemon *Daemon) localVolumesSize(ctx context.Context) (*types.VolumeDiskUsage, error) {
	volumes, _, err := daemon.usageVolumes.Do(ctx, struct{}{}, func(ctx context.Context) (*types.VolumeDiskUsage, error) {
		volumes, err := daemon.volumes.LocalVolumesSize(ctx)
		if err != nil {
			return nil, err
		}

		du := &types.VolumeDiskUsage{Items: volumes}
...
func (daemon *Daemon) SystemDiskUsage(ctx context.Context, opts system.DiskUsageOptions) (du *types.DiskUsage, err error) {
	...
	if opts.Images {
		...
		du.Images = &types.ImageDiskUsage{
