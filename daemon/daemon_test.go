...
func TestMerge(t *testing.T) {
	configImage := &containertypes.Config{
		ExposedPorts: containertypes.PortSet{
			containertypes.PortFrom(1111, containertypes.TCP): struct{}{},
			containertypes.PortFrom(2222, containertypes.TCP): struct{}{},
		},
	...
	configUser := &containertypes.Config{
		ExposedPorts: containertypes.PortSet{
			containertypes.PortFrom(2222, containertypes.TCP): struct{}{},
			containertypes.PortFrom(3333, containertypes.TCP): struct{}{},
		},
	...
	configImage2 := &containertypes.Config{
		ExposedPorts: map[containertypes.Port]struct{}{
			containertypes.PortFrom(0, containertypes.TCP): {},
		},
	}
