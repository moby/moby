...
func (c *Cluster) GetConfig(ctx context.Context, input string) (types.Config, error) {
...
func (c *Cluster) GetConfigs(ctx context.Context, options swarmbackend.ConfigListOptions) ([]types.Config, error) {
...
func (c *Cluster) CreateConfig(ctx context.Context, s types.ConfigSpec) (string, error) {
...
func (c *Cluster) RemoveConfig(ctx context.Context, input string) error {
...
func (c *Cluster) UpdateConfig(ctx context.Context, input string, version uint64, spec types.ConfigSpec) error {
	return c.lockedManagerAction(ctx, func(ctx context.Context, state nodeState) error {
		config, err := getConfig(ctx, state.controlClient, input)
		if err != nil {
			return err
