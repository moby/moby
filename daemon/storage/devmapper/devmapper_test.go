...
func init() {
	...
	if err := test.InitLoopbacks(); err != nil {
		panic(err)
	}
}
...
func TestDevmapperSetup(t *testing.T) {
	test.GetDriver(t, "devicemapper")
}

func TestDevmapperCreateEmpty(t *testing.T) {
	test.DriverTestCreateEmpty(t, "devicemapper")
}

func TestDevmapperCreateBase(t *testing.T) {
	test.DriverTestCreateBase(t, "devicemapper")
}

func TestDevmapperCreateSnap(t *testing.T) {
	test.DriverTestCreateSnap(t, "devicemapper")
}
...
func testChangeLoopBackSize(t *testing.T, delta, expectDataSize, expectMetaDataSize int64) {
	driver := test.GetDriver(t, "devicemapper").(*test.Driver).Driver.(*storage.NaiveDiffDriver).ProtoDriver.(*Driver)
	...
	driver = d.(*storage.NaiveDiffDriver).ProtoDriver.(*Driver)
