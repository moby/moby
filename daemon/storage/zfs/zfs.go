...
func Init(base string, opt []string, uidMaps, gidMaps []idtools.IDMap) (storage.Driver, error) {
	var err error
...
// GetMetadata returns image/container metadata related to storage driver
...
// FIXME(samoht): use "storage" instead of "graph"?
...
func (d *Driver) Put(id string) error {
	...
	mounted, err := storage.Mounted(storage.FsMagicZfs, mountpoint)
	if err != nil || !mounted {
		return err
	}
