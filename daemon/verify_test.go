...
func TestChecksumPath(t *testing.T) {
	...
	expected := digest.Digest("sha256:609bb33c4ee7ad2bbd34c6023b7aec000e932ccb681ff6995f9987e3235463d6")
...
func TestChecksumFilesystem(t *testing.T) {
	...
	expected2 := digest.Digest("sha256:16ddd217903a1a35f8f0f9cf9b5df07d024f63a4ba1c454d15b9d99aebf31ab9")
	if expected2 != dgst {
...
func NewMockLayerStore(root string) layer.Store {
