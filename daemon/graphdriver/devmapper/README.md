...
These options are currently documented both in [the man page](../../../docs/man/docker.1.md) and
in [the CLI docs](../../../docs/sources/reference/commandline/cli.md).  We would like to
deduplicate those, but if you add any options, please add them to both.
