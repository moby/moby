...
import (
	...
	"github.com/jhowardmsft/opengcs/gogcs"
)
...
func (d *Driver) CreateReadWrite(id, parent string, opts *graphdriver.CreateOpts) error {
	...
	return d.config.CreateSandbox(filepath.Join(d.dir(id), sandboxFilename), gogcs.DefaultSandboxSizeMB, d.cachedSandboxFile)
}
...
func (d *Driver) getEx(id string) (string, cacheType, int64, error) {
	...
	vhdFilename, vhdSize, isSandbox, err := gogcs.LayerVhdDetails(d.dir(id))
	if err != nil {
