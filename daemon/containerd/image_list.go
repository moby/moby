...
func (i *ImageService) Images(ctx context.Context, opts client.ImageListOptions) ([]*imagetypes.Summary, error) {
...
func (i *ImageService) imageSummary(ctx context.Context, img c8dimages.Image, platformMatcher platforms.MatchComparer,
	opts client.ImageListOptions, tagsByDigest map[digest.Digest][]string,
