...
func (i *ImageService) Images(ctx context.Context, opts client.ListOptions) ([]*imagetypes.Summary, error) {
...
func (i *ImageService) imageSummary(ctx context.Context, img c8dimages.Image, platformMatcher platforms.MatchComparer,
	opts client.ListOptions, tagsByDigest map[digest.Digest][]string,
