...
func TestLinkNew(t *testing.T) {
	...
	expected := &Link{
		...
		ParentIP: "172.0.17.3",
		ChildIP:  "172.0.17.2",
		Ports:    []container.Port{container.MustParsePort("6379/tcp")},
	}

	assert.DeepEqual(t, expected, link, cmp.AllowUnexported(container.Port{}))
}
...
func TestSortPorts(t *testing.T) {
	...
	assert.DeepEqual(t, expected, ports, cmp.AllowUnexported(container.Port{}))
}
