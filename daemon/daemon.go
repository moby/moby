...
func (daemon *Daemon) Install(eng *engine.Engine) error {
	...
	for name, method := range map[string]engine.Handler{
		...
		"container_copy":           daemon.ContainerCopy, // Deprecated.
		"container_stat_path":      daemon.ContainerStatPath,
		"container_archive_path":   daemon.ContainerArchivePath,
		"container_extract_to_dir": daemon.ContainerExtractToDir,
		"container_copy_across":    daemon.ContainerCopyAcross,
