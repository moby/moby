...
var (
	errConsumerGone = errors.New("consume is gone")
	errLogTooNew    = errors.New("log message is outside of requested window")
)
...
func (fwd *forwarder) Do(ctx context.Context, watcher *logger.LogWatcher, dec Decoder) (cont bool) {
