...
func (c *NRIConfig) UnmarshalJSON(raw []byte) error {
	dec := json.NewDecoder(bytes.NewReader(raw))
	dec.DisallowUnknownFields()
	type nc *NRIConfig // prevent recursion
...
// NRIConfigOpt is a NamedOption and flags.Value for NRI configuration parsing.
type NRIConfigOpt struct {
	Val *NRIConfig
}

func NewNamedNRIOptsRef(val *NRIConfig) *NRIConfigOpt {
	return &NRIConfigOpt{Val: val}
}

func (p *NRIConfigOpt) Set(value string) error {
...
func (p *NRIConfigOpt) Type() string {
	return "nri-options"
}

// String returns a string repr of this option
func (p *NRIConfigOpt) String() string {
...
func (p *NRIConfigOpt) Name() string {
	return "nri"
}
