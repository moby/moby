...
// BuildHostnameFile builds a new hostname file for the container.
...
// GetEndpointInNetwork returns the container's enpoint in the network.
func (container *Container) GetEndpointInNetwork(n libnetwork.Network) (libnetwork.Endpoint, error) {
	endpointName := strings.TrimPrefix(container.Name, "/")
	return n.EndpointByName(endpointName)
}

// buildPortMapInfo generates a network settings for the container endpoint.
...
// BuildEndpointInfo builds a new set of configuration settings for the container network.
...
// UpdateJoinInfo updates the network information for the container.
...
// UpdateSandboxNetworkSettings modify the container network settings
// with the new sandbox ids.
...
// BuildCreateEndpointOptions collects the endpoint options for a container's endpoint.
...
// SetupWorkingDirectory initializes the working directory for the container.
...
// disconnectFromNetwork disconnect and removes the container from the network.
func (container *Container) disconnectFromNetwork(n libnetwork.Network) error {
	var (
...
// NetworkMounts returns the networking mount points.
...
// CopyImagePathContent backs up the content of the path to mount in the container.
...
// ShmResourcePath returns the resource path for shm.
func (container *Container) ShmResourcePath() (string, error) {
	return container.GetRootResourcePath("shm")
}

// MqueueResourcePath returns the resource path for mqueue.
func (container *Container) MqueueResourcePath() (string, error) {
	return container.GetRootResourcePath("mqueue")
}

// HasMountFor checks whether the container already has this path
// configured to be mounted or not.
