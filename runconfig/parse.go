...
func Parse(cmd *flag.FlagSet, args []string) (*Config, *HostConfig, *flag.FlagSet, error) {
	...
	config := &Config{
		...
		Env:             stringutils.NewStrSlice(envVariables...),
		Cmd:             runCmd,
		Image:           image,
	...
	hostConfig := &HostConfig{
		Binds:            stringutils.NewStrSlice(binds...),
		...
		Links:            stringutils.NewStrSlice(flLinks.GetAll()...),
		PublishAllPorts:  *flPublishAll,
		DNS:              stringutils.NewStrSlice(flDNS.GetAll()...),
		DNSSearch:        stringutils.NewStrSlice(flDNSSearch.GetAll()...),
		ExtraHosts:       stringutils.NewStrSlice(flExtraHosts.GetAll()...),
		VolumesFrom:      stringutils.NewStrSlice(flVolumesFrom.GetAll()...),
		...
		SecurityOpt:      stringutils.NewStrSlice(flSecurityOpt.GetAll()...),
