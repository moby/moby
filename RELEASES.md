...
- [:pushpin: Versioning](#pushpin-versioning)
- [:hourglass\_flowing\_sand: Release cadence](#hourglass_flowing_sand-release-cadence)
- [:dart: Major and minor releases](#dart-major-and-minor-releases)
- [:hammer\_and\_wrench: Patch releases](#hammer_and_wrench-patch-releases)
- [:fire: Prioritization of fixes](#fire-prioritization-of-fixes)
- [:clapper: Pre-releases](#clapper-pre-releases)
...
## :hourglass_flowing_sand: Release cadence
...
## :hammer_and_wrench: Patch releases
