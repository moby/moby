...
func (b *buildFile) CmdRun(args string) error {
	...
	config, _, _, err := core.ParseRun([]string{b.image, "/bin/sh", "-c", args}, nil)
	if err != nil {
		return err
	}
	...
	cmd := b.config.Cmd
	b.config.Cmd = nil
	core.MergeConfig(b.config, config)
...
func (b *buildFile) CmdVolume(args string) error {
	...
	if b.config.Volumes == nil {
		b.config.Volumes = core.NewPathOpts()
	}
...
func (b *buildFile) addRemote(container *core.Container, orig, dest string) error {
...
func (b *buildFile) addContext(container *core.Container, orig, dest string) error {
