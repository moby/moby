...
func TestCpToCaseA(t *testing.T) {
	cID := makeTestContainerCatFile(t, false, nil, "/root", "itWorks.txt")
	defer deleteContainer(cID)
...
func TestCpToCaseB(t *testing.T) {
	cID := makeTestContainerCatFile(t, false, nil, "", "testDir/file1")
	defer deleteContainer(cID)
...
func TestCpToCaseC(t *testing.T) {
	cID := makeTestContainerCatFile(t, true, nil, "/root", "file2")
	defer deleteContainer(cID)
...
func TestCpToCaseD(t *testing.T) {
	cID := makeTestContainerCatFile(t, true, nil, "", "/dir1/file1")
	defer deleteContainer(cID)
...
func TestCpToCaseE(t *testing.T) {
	cID := makeTestContainerCatFile(t, false, nil, "", "/testDir/file1-1")
	defer deleteContainer(cID)
...
func TestCpToCaseG(t *testing.T) {
	cID := makeTestContainerCatFile(t, true, nil, "/root", "dir2/dir1/file1-1")
	defer deleteContainer(cID)
	...
	// Make new destination container.
	cID = makeTestContainerCatFile(t, true, nil, "", "/dir2/dir1/file1-1")
	defer deleteContainer(cID)
...
func TestCpToCaseJ(t *testing.T) {
	cID := makeTestContainerCatFile(t, true, nil, "/root", "/dir2/file1-1")
	defer deleteContainer(cID)
	...
	// Make new destination container.
	cID = makeTestContainerCatFile(t, false, nil, "", "/dir2/file1-1")
	defer deleteContainer(cID)
