...
func TestCpWithVolErrSrcNotExists(t *testing.T) {
	...
	srcID := makeTestContainer(t, testContainerOptions{
		volumes: defaultVolumes(tmpDir),
	})
	defer deleteContainer(srcID)

	dstID := makeTestContainer(t, testContainerOptions{
		volumes: defaultVolumes(tmpDir),
	})
...
func TestCpWithVolCaseA(t *testing.T) {
	...
	dstID := makeTestContainer(t, testContainerOptions{
		volumes: defaultVolumes(tmpDir), workDir: "/vol3",
		command: makeCatFileCommand("itWorks.txt"),
	})
	defer deleteContainer(dstID)
...
func TestCpWithVolCaseB(t *testing.T) {
	...
	srcID := makeTestContainer(t, testContainerOptions{
		volumes: defaultVolumes(tmpDir), workDir: "/vol2",
	})
	defer deleteContainer(srcID)
...
func TestCpWithVolCaseC(t *testing.T) {
	...
	dstID := makeTestContainer(t, testContainerOptions{
		volumes: defaultVolumes(tmpDir), workDir: "/vol2/vol3",
		command: makeCatFileCommand("/vol2/file2"),
	})
	defer deleteContainer(dstID)
...
func TestCpWithVolCaseD(t *testing.T) {
	...
	dstID := makeTestContainer(t, testContainerOptions{
		volumes: defaultVolumes(tmpDir),
		command: makeCatFileCommand("/vol1/file1"),
	})
	defer deleteContainer(dstID)
...
func TestCpWithVolCaseE(t *testing.T) {
	...
	dstID := makeTestContainer(t, testContainerOptions{
		volumes: defaultVolumes(tmpDir), workDir: "/vol1",
		command: makeCatFileCommand("/vol1/testDir/file1"),
	})
	defer deleteContainer(dstID)
...
func TestCpWithVolCaseG(t *testing.T) {
	...
	dstID := makeTestContainer(t, testContainerOptions{
		volumes: defaultVolumes(tmpDir), workDir: "/vol2/vol3",
		command: makeCatFileCommand("/vol1/vol2/dir1/file1-1"),
	})
	defer deleteContainer(dstID)
...
func TestCpWithVolCaseH(t *testing.T) {
	...
	dstID := makeTestContainer(t, testContainerOptions{
		volumes: defaultVolumes(tmpDir),
		command: makeCatFileCommand("/vol1/testDir/dir1/file1-1"),
	})
	defer deleteContainer(dstID)
...
func TestCpWithVolCaseJ(t *testing.T) {
	...
	dstID := makeTestContainer(t, testContainerOptions{
		volumes: defaultVolumes(tmpDir), workDir: "/root",
		command: makeCatFileCommand("/vol1/file1-1"),
	})
	defer deleteContainer(dstID)
