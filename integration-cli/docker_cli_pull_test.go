...
func TestPullFromAdditionalRegistry(t *testing.T) {
	...
	if _, err := d.Cmd("pull", "library/hello-world"); err != nil {
		t.Fatalf("we should have been able to pull library/hello-world from %q: %v", reg.url, err)
	}
	...
	if _, err := d.Cmd("pull", "docker.io/library/hello-world"); err != nil {
		t.Fatalf("we should have been able to pull docker.io/library/hello-world from %q: %v", reg.url, err)
	}
...
func TestPullFromAdditionalRegistries(t *testing.T) {
	...
	if _, err := d.Cmd("pull", "library/hello-world"); err != nil {
		t.Fatalf("we should have been able to pull library/hello-world from %q: %v", reg2.url, err)
	}
	...
	if _, err := d.Cmd("pull", "misc/hello-world"); err != nil {
		t.Fatalf("we should have been able to pull misc/hello-world from %q: %v", reg2.url, err)
	}
	...
	if _, err := d.Cmd("pull", "library/hello-world"); err != nil {
		t.Fatalf("we should have been able to pull library/hello-world from %q: %v", reg1.url, err)
	}
...
func doTestPullFromPrivateRegistriesWithPublicBlocked(t *testing.T, daemonArgs []string) {
	...
	if _, err := d.Cmd("pull", "misc/busybox"); err != nil {
		t.Fatalf("we should have been able to pull misc/hello-world from %q: %v", reg1.url, err)
	}
