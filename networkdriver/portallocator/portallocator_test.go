...
func TestRequestNewPort6(t *testing.T) {
	defer reset()

	port, err := RequestPort(defaultIP6, "tcp", 0)
	if err != nil {
		t.Fatal(err)
	}
...
func TestRequestSpecificPort6(t *testing.T) {
	defer reset()

	port, err := RequestPort(defaultIP6, "tcp", 5000)
	if err != nil {
		t.Fatal(err)
	}
	if port != 5000 {
...
func TestReleasePort6(t *testing.T) {
	defer reset()
	...
	if err := ReleasePort(defaultIP6, "tcp", 5000); err != nil {
		t.Fatal(err)
	}
}
...
func TestReuseReleasedPort6(t *testing.T) {
	defer reset()
...
func TestReleaseUnreadledPort6(t *testing.T) {
	defer reset()
...
func TestPortAllocation6(t *testing.T) {
	defer reset()
