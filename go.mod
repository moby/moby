...
require (
	...
	google.golang.org/genproto v0.0.0-20250922171735-9219d122eba9 // indirect; TODO(thaJeztah): should we keep this one aligned with the other google.golang.org/genproto/xxx modules?
