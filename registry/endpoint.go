...
func (e *Endpoint) pingV1() (RegistryInfo, error) {
	...
	resp, err := HTTPClient(DefaultTransport(ConnectTimeout, e.IsSecure)).Do(req)
	if err != nil {
		return RegistryInfo{Standalone: false}, err
	}
...
func (e *Endpoint) HTTPClient() *http.Client {
	// TODO: shouldn't this be ConnectTimeout for safety?
	return HTTPClient(DefaultTransport(NoTimeout, e.IsSecure))
}
