...
type Store interface {
	Register(io.Reader, ChainID, Platform, *RegisterOpts) (Layer, error)
...
type DescribableStore interface {
	RegisterWithDescriptor(io.Reader, ChainID, Platform, distribution.Descriptor, *RegisterOpts) (Layer, error)
}
